...
To use this project in you own cmake project include it with :
...
```
target_link_libraries(my-target PUBLIC nlohmann_json_schema_validator)
```
...
`nlohmann-json` will be fetch using cmake `FetchContent`.
